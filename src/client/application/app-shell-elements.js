export function bindAppShellElements(doc = document) {
  return {
    ...
    reviewApproveBtn: doc.getElementById('reviewApproveBtn'),
    reviewApproveProceedBtn: doc.getElementById('reviewApproveProceedBtn'),
    reviewDenyBtn: doc.getElementById('reviewDenyBtn'),
    reviewConcludeReason: doc.getElementById('reviewConcludeReason'),
